    ...
    def fill_result_table(self) -> None:
        ...
        for (number, i) in enumerate(self.duration_values):
            ...
            if i[0] not in self.max_id:
                ...
                print("Error 01 in computing of 'max_id', an 'max_id' is not printed in the table.");
            if (self.max_id[i[0]][0] != max(i[1])):
                print("Error 02 in computing of 'max_id', an 'max_id' is not printed in the table.");
                self.max_id[i[0]][1] = 'in file';
        ...
        number = 0
        for (i1, i2, i3, i4, i5, i6, i7, i8, i9) in result_table:
            number += 1
            enumerated_unsorted_table.append((number, i1, i2, i3, i4, i5, i6, i7, i8, i9))
